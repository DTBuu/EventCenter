...
CREATE TABLE `chutri` (
  `ChuTri_id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `diadiemtochuc` (
  ...
  `DDTC_hinhanh` varchar(240) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`DDTC_id`),
  KEY `DDTC_id` (`DDTC_id`)
...
INSERT INTO `diadiemtochuc` VALUES (1,'Lau 1 Sanh A',100,5900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639635710/lau_1_sanh_a_z89ypr.jpg'),(2,'Lau 1 Sanh B',200,6900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639635710/lau_1_sanh_b_qvhiff.jpg'),(3,'Lau 1 Sanh C',100,5900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639635710/lau_1_sanh_c_fvgvne.jpg'),(4,'Lau 2 Sanh A',100,5900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639635709/lau_2_sanh_a_paypeb.jpg'),(5,'Lau 2 Sanh B',200,6900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639635709/lau_2_sanh_b_bczyqd.jpg'),(6,'Lau 2 Sanh C',100,5900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639635712/lau_2_sanh_c_ludlxv.jpg'),(7,'Tang thuong',300,9900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639635716/tang_thuong_z0u6w3.jpg'),(8,'Khuon vien mat tien',100,4900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639799912/khuon_vien_mat_tien_dx9utz.jpg'),(9,'Khuon vien mat hau',100,3900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639799912/khuon_vien_mat_hau_ltutwe.jpg'),(10,'Khuon vien ben trai',100,3900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639799915/khuon_vien_ben_trai_m3kh4s.jpg'),(11,'Khuon vien ben phai',100,3900000,NULL,'https://res.cloudinary.com/springweb/image/upload/v1639799912/khuon_vien_ben_phai_kp6skb.jpg');
...
CREATE TABLE `giaitri` (
  `GiaiTri_id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `items_in_menus` VALUES (2,4,87000,50,NULL),(2,26,9800000,50,NULL),(3,5,77000,50,NULL),(3,6,97000,50,NULL),(3,7,91000,50,NULL),(3,8,81000,50,NULL),(3,27,14900000,50,NULL),(4,9,101000,50,NULL),(4,10,109000,50,NULL),(4,11,66000,50,NULL),(4,12,73000,50,NULL),(4,28,13300000,50,NULL),(5,17,95000,50,NULL),(5,18,164000,50,NULL),(5,19,66000,50,NULL),(5,20,198000,50,NULL),(6,13,128000,50,NULL),(6,14,33000,50,NULL),(6,15,169000,50,NULL),(6,16,150000,50,NULL),(6,29,10990000,50,NULL),(7,1,1212,12,NULL),(7,2,1212,12,NULL),(7,3,123,50,NULL),(10,1,123,123,NULL);
...
INSERT INTO `khachhang` VALUES (1,NULL,'AJDYA','AJDYA','1998-08-12','Tay Ninh','9487859132','AJDYA',NULL),(2,NULL,'YXBAI','YXBAI','1995-06-23','Nam Dinh','9104375610','YXBAI',NULL),(3,NULL,'JXCDL','JXCDL','1991-04-15','Thanh Hoa','4144298113','JXCDL',NULL),(4,NULL,'HPOAM','HPOAM','1994-10-07','Kon Tum','2154889265','HPOAM',NULL),(5,NULL,'VSXAD','VSXAD','1990-01-11','Bac Giang','3605646263','VSXAD',NULL),(6,NULL,'GRWFV','GRWFV','1996-03-09','Bac Ninh','3633111936','GRWFV',NULL),(7,NULL,'YYOGS','YYOGS','1993-02-25','Ha Giang','3964960713','YYOGS',NULL),(8,NULL,'XVOFF','XVOFF','1995-10-08','Thanh Hoa','0486655991','XVOFF',NULL),(9,NULL,'TDUFK','TDUFK','1992-03-23','Lang Son','8604683836','TDUFK',NULL),(10,NULL,'UTBCY','UTBCY','1991-01-29','Ba Ria - Vung Tau','3575516117','UTBCY',NULL),(11,12,'zxczcx','zcxccxczx','2000-01-01','nzcn','0909000000','abc@gmail.com',NULL),(12,13,'mnnmb','cmncnmc','2000-01-01','cxcnvn','0909090090','abc@gmaill.com',NULL),(13,14,'diep','phi','2000-01-02','binh son','0909090090','abc@gmail.com',NULL),(14,15,'abc','abc','2000-01-01','bs','0909000000','bac@gmail.com',NULL),(15,16,'Nguyen Van','A','2000-01-01','qunag ngai','0909000000','dipe@gmail.com',NULL),(16,17,'Nguyen Van','A','2000-01-01','qunag ngai','0909000000','dipe@gmail.com',NULL),(17,18,'','A','2000-01-01','qunag ngai','0909000000','dipe@gmail.com',NULL),(18,19,'Nguyen Van','Tuan','2000-01-01','qunag ngai','0909000000','dipe@gmail.com',NULL),(19,20,'Nguyen','A','2000-01-01','ququq','0909090909','diep@gmail.com',NULL),(20,21,'phi','phi','2000-01-01','quan','0909000000','diep@gmail.com',NULL),(21,22,'Diep hoang','phi','2000-01-01','quang ngai','0900900900','email@gmail.com',NULL),(22,23,'Diep hoang','phi','2000-01-01','Quang Ngai','0909000000','email@gmail.com',NULL);
...
INSERT INTO `logins` VALUES (1,'ROLE_MANAGER','dtbuu','111',NULL,NULL),(2,'ROLE_MANAGER','dhphi','$2a$10$oxERfHujJraWAw0VZ6qaCeLeiEwh08Y5K6UId/0rWSFjbVh2OxVp6',NULL,NULL),(3,'ROLE_STAFF','tkbao','333',NULL,NULL),(4,'ROLE_STAFF','dtdat','555',NULL,NULL),(5,'ROLE_STAFF','llrot','444',NULL,NULL),(6,'ROLE_STAFF','phucvu','222',NULL,NULL),(7,'ROLE_STAFF','daubep','333',NULL,NULL),(8,'ROLE_STAFF','vesinh','444',NULL,NULL),(9,'ROLE_STAFF','ketoan','777',NULL,NULL),(10,'ROLE_STAFF','letan','666',NULL,NULL),(11,'ROLE_STAFF','baove','555',NULL,NULL),(12,'ROLE_GUEST','ba','$2a$10$3PPowuLLJ0VSGKMsEhdqVufEYNVLOjD2UjEAAEcnQDur5VZoiNVYq',NULL,NULL),(13,'ROLE_GUEST','nvnv','$2a$10$G2vrAShNdQO6cpuDIuuMje1ptKFJ1h8IoTuZ2fuJyN0.C0.jZTPZy',NULL,NULL),(14,'ROLE_MANAGER','phi','$2a$10$L1NebCwzBCUhfU9r1.EySukWvHp7rMnn59v3kQXXEl742zgPatq/q',NULL,NULL),(15,'ROLE_GUEST','admin','$2a$10$dCK40d.r27AJh3WGRU4sS.Kk4ZM2trv55RH.ounfmEqModYn.754i',NULL,NULL),(16,'ROLE_GUEST','alo','$2a$10$/y4N.89LqpjEebEzCzN1beIBVQMpg3wFjd33Jvb2z7dsXR8Jvk1LK',NULL,NULL),(17,'ROLE_GUEST','test','$2a$10$oFSzpFXK6A3h5WwtIKyPRecay2prWr346DWLAzwYgShbed5sdGvsi',NULL,NULL),(18,'ROLE_GUEST','test2','$2a$10$CenCXZKXsLb5o0bgnqoUiu1NHBItbxx3QH458E5I1kvFtypnDRI/6',NULL,'https://res.cloudinary.com/springweb/image/upload/v1637659166/elmu6kwjzgbujpckiwlq.png'),(19,'ROLE_GUEST','test3','$2a$10$BIR.TVIVRoHANvHqqWrzFuhKfi0SV9ZZpIxt5pALY.mhRjXLD6f2.',NULL,'https://res.cloudinary.com/springweb/image/upload/v1637201722/sample.jpg'),(20,'ROLE_GUEST','test4','$2a$10$RPaRoC2lxVdJzYgUDGjZfea9M9Q8omRhF9fmbAF0v3Oeb.NJ3t2mC',NULL,'https://res.cloudinary.com/springweb/image/upload/v1637765086/vanmmvp1ztx0blcfbmpq.png'),(21,'ROLE_GUEST','thu','$2a$10$j6m.U7FTHoMOOeHl1aneY.uP/lpYRi9wGIF7BNEnH/Jc8SJRJHxnm',NULL,'https://res.cloudinary.com/springweb/image/upload/v1638199095/ahahk9wfvaele44mwxwz.png'),(22,'ROLE_GUEST','test7','$2a$10$WPG5I1b17SbiIc2um7H58uLvLG5pULN5q1HMdyCVLpRaTMcuKokM2',NULL,'https://res.cloudinary.com/springweb/image/upload/v1638774678/ectqyntwpzuip4u6chxt.jpg'),(23,'ROLE_GUEST','test6','$2a$10$hHsWCS9u9Di5uCcZbjv3G.P14HM/HIxw4CxaZ0ZT0ryTPO2CIbnky',NULL,'https://res.cloudinary.com/springweb/image/upload/v1639798773/jcsulsese6wrg9wjsikq.jpg');
...
INSERT INTO `menus` VALUES (1,'Theo yeu cau','Bao gia sau'),(2,'Am thuc Mien Bac',NULL),(3,'Am thuc Mien Trung',NULL),(4,'Am thuc Mien Nam',NULL),(5,'Am thuc chay',NULL),(6,'Am thuc Phuong Tay',NULL),(7,'dfadsfasdf',NULL),(8,'ádfasdfsadf',NULL),(9,'sdfsdfsdf',NULL),(10,'sdfsdf',NULL);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `phucvu` (
  `PhucVu_id` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `phucvu` VALUES (1,'Theo yeu cau',0,'Bao gia sau'),(2,'Goi phuc vu pho thong ',15000000,''),(3,'Goi phuc vu dong',19000000,''),(4,'Goi phuc vu bac',29000000,''),(5,'Goi phuc vu vang',39000000,''),(6,'Goi phuc vu dac biet',49000000,'');
...
CREATE TABLE `sukien` (
  ...
  `SuKien_loai` varchar(100) NOT NULL,
...
INSERT INTO `sukien` VALUES (37,'adsf','adsf',14,NULL,1,12,1,1,1,1,1,'0019-01-13','0020-01-13',NULL,NULL);
...
INSERT INTO `thanhtoan` VALUES (1,2,'2021-12-12',1323,'mnm','mn'),(4,37,'2021-12-19',70800000,'tien mat',NULL);
...
CREATE TABLE `trangtri` (
  `TrangTri_id` int NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2021-12-19  9:53:52
